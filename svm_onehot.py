...
def init_params(options):
    ...
    params['W_rnn'] = np.random.uniform(-0.01, 0.01, (options['inputDimSize'], options['hiddenDimSize']))
...
if __name__ == '__main__':
    ...
    train_RNN_SVM(dataFile=dataFile, labelFile=labelFile, outFile=outFile, inputDimSize=inputDimSize, hiddenDimSize=hiddenDimSize, max_epochs=max_epochs, L2_reg=L2_reg, batchSize=batchSize, use_dropout=use_dropout)